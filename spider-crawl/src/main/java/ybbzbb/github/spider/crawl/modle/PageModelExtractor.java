...
import ybbzbb.github.spider.core.model.AfterExtractor;
import ybbzbb.github.spider.core.model.Extractor;
import ybbzbb.github.spider.core.model.FieldExtractor;
import ybbzbb.github.spider.core.model.annotation.*;
import ybbzbb.github.spider.core.model.formatter.ObjectFormatter;
import ybbzbb.github.spider.core.model.formatter.ObjectFormatterBuilder;
import ybbzbb.github.spider.core.selector.*;
import ybbzbb.github.spider.core.util.ClassUtils;
import ybbzbb.github.spider.core.util.ExtractorUtils;
...
class PageModelExtractor {
    ...
    private void initClassExtractors() {
        ...
        if (annotation == null) {
            ...
            for (String s : value) {
                targetUrlPatterns.add(Pattern.compile(s.replace(".", "\\.")
//                        .replace("*", "[^\"'#]*")
                ));
            }
